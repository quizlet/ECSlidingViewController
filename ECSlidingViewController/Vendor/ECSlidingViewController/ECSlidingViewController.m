...
- (void)updateTopViewHorizontalCenterWithRecognizer:(UIPanGestureRecognizer *)recognizer
{
  ...
  if (recognizer.state == UIGestureRecognizerStateBegan) {
    ...
    CGFloat newCenterPosition = self.initialHoizontalCenter - panAmount;
      ...
      CGFloat halfWidth = [[self topView] frame].size.width/2;
      if (newCenterPosition-halfWidth > [self anchorRightRevealAmount] && [self underLeftWidthLayout] != ECFullWidth)
          newCenterPosition = [self anchorRightRevealAmount]+halfWidth;
